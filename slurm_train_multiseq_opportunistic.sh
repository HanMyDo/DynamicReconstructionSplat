#!/bin/sh
#SBATCH --job-name=train_multiseq_opp
#SBATCH --partition=24g
#SBATCH --qos=students_opportunistic
#SBATCH --output=slurm_logs/train_multiseq_opp_%j.out
#SBATCH --error=slurm_logs/train_multiseq_opp_%j.err
#SBATCH --gres=gpu:1
#SBATCH --nodes=1
...
echo "=============================================="
echo "Multi-Sequence Training - Opportunistic (resume)"
echo "=============================================="
...
enroot remove -f train_multiseq_opp 2>/dev/null || true
enroot create --name train_multiseq_opp ~/anysplat.sqsh

enroot start --root --rw --mount /mnt:/mnt --mount /tmp:/tmp train_multiseq_opp bash -c "
  ...
  python train_temporal_gaussian_head.py \
    ...
    --resume output_finetune_multiseq_12f/checkpoint_latest.pt \
    --num_epochs 20 \
    --batch_size 1 \
    --learning_rate 1e-4 \
    --num_frames 12 \
...
enroot remove -f train_multiseq_opp
