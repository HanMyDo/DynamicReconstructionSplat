...
from src.model.encoder.vggt4d.layers.block import BlockFor4D
from src.model.encoder.vggt.models.aggregator import Aggregator, slice_expand_and_flatten
...
class AggregatorFor4D(Aggregator):
    ...
    def forward(self, images: torch.Tensor,
        ...
        frame_idx = 0
        global_idx = 0
        output_list = []  # List of layer outputs (compatible with VGGT format)
        global_q_list = []
        frame_q_list = []
        global_k_list = []
        frame_k_list = []
        ...
        for i in range(self.aa_block_num):
            ...
            # Only keep layers in preserve_layer_idx to match VGGT behavior
